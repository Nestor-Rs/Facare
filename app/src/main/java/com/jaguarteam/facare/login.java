        ...
        if(txtUser.getText().toString().isEmpty()){
            ...
            if(SessionUser!=null){
                ...
                if(SessionUser.isPoliticas()){
                    Intent miIntent = new Intent(login.this, MenuCuestionario.class);
                    miIntent.putExtra("Usuario",SessionUser);
                    startActivity(miIntent);
                }
                else{
                    Intent miIntent = new Intent(login.this, AvisoPrivacidad.class);
                    miIntent.putExtra("Usuario",SessionUser);
                    startActivity(miIntent);
                }
            }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.LRecuperarContra:
                miIntent = new Intent(login.this,RecuperarContra.class);
                startActivity(miIntent);
                break;
            case R.id.LRegistrarte:
                miIntent = new Intent(login.this,RegistroSinCorreoA.class);
                startActivity(miIntent);
        }
    }
}